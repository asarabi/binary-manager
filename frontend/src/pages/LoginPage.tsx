      ...
      <div className="bg-white border border-gray-200 p-8 rounded-2xl w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            ...
            className="w-full mt-4 bg-gray-900 text-white py-2.5 px-4 rounded-xl text-sm font-medium hover:bg-gray-800 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
          >
